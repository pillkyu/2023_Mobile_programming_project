...
public class pauseFragment_ch extends Fragment{
    //Fragment 관련 코드 작성
    @Override
        ...
        btnresume.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getParentFragmentManager() != null) {
                    ...
                    ((ChallengeModePlayScreen) getActivity()).resumeTimerFromFragment();
                    getParentFragmentManager().beginTransaction().remove(pauseFragment_ch.this).commit();
                }
            }
        });
